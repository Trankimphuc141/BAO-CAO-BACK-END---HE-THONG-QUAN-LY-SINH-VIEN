    ...
    return (
        <Box sx={{ minHeight: '100vh' }}>
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Box sx={{ flex: 1 }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 0.75 }}>
                            <SchoolIcon sx={{ fontSize: { xs: 28, sm: 34 } }} />
                            <Typography variant="h4" fontWeight={800} sx={{ fontSize: { xs: '1.5rem', sm: '1.85rem', md: '2.1rem' }, letterSpacing: '-0.02em' }}>
                                Quản lý Sinh viên
                            </Typography>
                        </Box>
                        <Typography variant="body1" sx={{ opacity: 0.9, fontSize: { xs: '0.88rem', sm: '0.98rem' }, lineHeight: 1.5 }}>
                ...
                {/* Stats */}
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2, mt: 3.5, width: '100%' }}>
                    {[
                        ...
                        <Box key={stat.label} sx={{
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.2 }}>
                                <Typography sx={{ fontSize: '1.3rem', lineHeight: 1 }}>{stat.icon}</Typography>
                                <Typography variant="h5" fontWeight={800} sx={{ lineHeight: 1 }}>{stat.value}</Typography>
                            </Box>
                            <Typography variant="caption" sx={{ opacity: 0.9, mt: 0.75, display: 'block', fontWeight: 600, fontSize: '0.82rem', whiteSpace: 'nowrap' }}>
                                {stat.label}
                            </Typography>
                        </Box>
                    ))}
            ...
            <Paper elevation={0} sx={{ p: 2.5, mb: 3, borderRadius: 3, border: '1px solid', borderColor: 'divider' }}>
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2, alignItems: 'center', width: '100%' }}>
                    <TextField
                        ...
                        sx={{ flex: { xs: '1 1 100%', md: '2 1 300px' } }}
                    />
                    <TextField
                        select
                        size="small"
                        ...
                        sx={{ flex: { xs: '1 1 140px', md: '1 1 170px' }, minWidth: 150, '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
                    >
                    ...
                    <Box sx={{ display: 'flex', gap: 1, flexShrink: 0 }}>
                        <Button
                            variant="contained"
                            onClick={() => { setPage(0); fetchStudents(); }}
                        ...
                        {(search || classFilter || statusFilter) && (
                            <Button
                                variant="outlined"
                                onClick={() => { setSearch(''); setClassFilter(''); setStatusFilter(''); setPage(0); }}
                                ...
                                <TableRow>
                                    <TableCell colSpan={7}>
                                        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', py: 8, gap: 1.5 }}>
                                            <Box sx={{ p: 2, bgcolor: alpha('#4F46E5', 0.08), borderRadius: '50%', color: '#4F46E5', mb: 0.5 }}>
                                                <Group sx={{ fontSize: 44 }} />
                                            </Box>
                                            <Typography variant="h6" fontWeight={700} color="text.primary">Không tìm thấy sinh viên nào</Typography>
                                            <Typography variant="body2" color="text.secondary">Chưa có dữ liệu sinh viên phù hợp với bộ lọc tìm kiếm.</Typography>
                                        </Box>
                                    </TableCell>
                                </TableRow>
                            )}
